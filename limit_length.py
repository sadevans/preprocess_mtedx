...
def main():
    ...
    src_filename = f"{args.root_dir}{args.dataset}_{args.subset}_transcript_lengths_seg{args.seg_duration}s.csv"
    src_filename = os.path.join(args.root_dir, "labels", f"{args.dataset}_{args.subset}_transcript_lengths_seg{args.seg_duration}s.csv")
    dst_filename = os.path.join(args.root_dir, "labels", f"{args.dataset}_{args.subset}_transcript_lengths_seg{args.seg_duration}s_0to{args.max_length}.csv")
